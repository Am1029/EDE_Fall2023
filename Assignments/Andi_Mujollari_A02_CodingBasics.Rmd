...
#Here we ask R is mean is grater than the median
mean_grater_than_median <- mean_value > median_value
cat("Mean:", mean_value, "\n")
cat("Median:",median_value, "\n")
cat("Is mean grater than median?", mean_grater_than_median, "\n")
#1. 
...
#In the third Vector i set if they passed the test (TRUE or FALSE) with a passing grade of 50
...
> Answer:n Data frames allows me to use different data types combined together. On the other hand, if i had to use a matrix instead, i would have to convert all the data in one type.
...
# Retelling R what where the scores of our students at Q5
student_scores <- c(98, 67, 76, 34)
...
```{r}
#To compare the option first i have to try also the ifelse command 
check_passing_score <- function(score) {
