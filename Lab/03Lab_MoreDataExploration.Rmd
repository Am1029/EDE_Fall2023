...
```{r DataExercise-1a}
hight_F <- c(81,83,83,84,78,71,79,82,85,84) #This vector represents the highest temperature from 9/18 till 9/27
hight_F

low_F <- c(55,56,58,60,61,63,63,64,64,63) #This vector represents the lowest temperature from 9/18 till 9/27
low_F
```
...
```{r DataExercise-1c}
df_temp <- data.frame("High.temp.in.F" = hight_F,high_C, low_F, low_C)
df_temp
```
